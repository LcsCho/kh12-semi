...
<aside>
                    <div class="flex-container vertical center">
                        <div class="row">
                            <h2><a href="/admin/seatArea/insert" class="link">구역 등록</a></h2>
                        </div>
                        <div class="row">
                            <h2><a href="/admin/seatArea/list" class="link">구역 목록</a></h2>
                        </div>
                       <div class="row"> 
                         <h2><a href="/admin/seat/insert" class="link">좌석 등록</a></h2> 
                      </div>
                     <div class="row"> 
                            <h2><a href="/admin/seat/list" class="link">좌석 목록</a></h2>
                       </div> 
<!--                         <div class="row"> -->
