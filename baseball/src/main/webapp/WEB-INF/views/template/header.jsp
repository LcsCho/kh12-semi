			...
			<nav>
				<ul class="menu center">
					<div class="title float-container">
						<div class="row col-5">
							<div class="row">
								<li><a href="/schedule/doosan"> <i
										class="fa-solid fa-calendar-days"></i></a></li>
							</div>
							<div class="row i-font">경기일정</div>
						</div>
						<div class="row col-5">
							<div class="row">
								<li><a href="/reservationList"> <i
										class="fa-solid fa-ticket"></i></a></li>
							</div>
							<div class="row i-font">예매하기</div>
						</div>
						<div class="row col-5">
							<div class="row">
								<li><a href="/teamInfo"> <i
										class="fa-solid fa-baseball-bat-ball"></i></a></li>
							</div>
							<div class="row i-font">팀정보</div>
						</div>
						<div class="row col-5">
							<div class="row">
								<li><a href="/ranking"> <i
										class="fa-solid fa-ranking-star"></i></a></li>
							</div>
							<div class="row i-font">팀순위</div>
						</div>
						<div class="row col-5">
							<div class="row">
